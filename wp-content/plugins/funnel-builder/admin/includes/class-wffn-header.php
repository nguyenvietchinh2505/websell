...
final class WFFN_Header {
	...
	public function set_level_1_navigation_active( $active = '' ) {
		...
		if ( 'funnels' === $active && isset( $_GET['wffn_funnel_ref'] ) && absint( $_GET['wffn_funnel_ref'] ) === WFFN_Common::get_store_checkout_id() ) {
	...
	public static function left_navigation() {
        ...
        if ( 'activated' !== WFFN_Core()->page_builders->get_plugin_status( 'cart-for-woocommerce/plugin.php' ) ) {
	        $header_menu['cart'] = [
            ...
            <div class="bwfan_header_l1">
                ...
                <div class="bwfan_header_r">
                    ...
                    <div class="bwfan_navigation bwf-header-ellipses-wrap">
						<?php
						$this->outputEllipsisMenu( $navigation['menu'] );
						?>
                    </div>
                </div>
            </div>
