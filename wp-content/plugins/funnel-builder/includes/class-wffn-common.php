...
if ( ! class_exists( 'WFFN_Common' ) ) {
	class WFFN_Common {
		...
		public static function pixel_advanced_matching_data() {
			...
			$params = apply_filters( 'wffn_fb_advanced_matching_data', $params );
		...
		public static function skip_automation_page() {
			$fb_site_option = get_option( 'fb_site_options', [] );
			if ( ! isset( $fb_site_option['skip_automation_page'] ) || 1 !== intval( $fb_site_option['skip_automation_page'] ) ) {
				return false;
			}
