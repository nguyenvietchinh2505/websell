...
class WooFunnels_Contact {
	...
	public function get_status() {
		...
		$db_status = ( isset( $this->db_contact->status ) && '' !== $this->db_contact->status ) ? $this->db_contact->status : 0;
	...
	public function get_wpid() {
		$wp_id   = ( isset( $this->wp_id ) && intval( $this->wp_id ) > 0 ) ? intval( $this->wp_id ) : 0;
		$db_wpid = ( isset( $this->db_contact->wpid ) && intval( $this->db_contact->wpid ) > 0 ) ? intval( $this->db_contact->wpid ) : 0;
