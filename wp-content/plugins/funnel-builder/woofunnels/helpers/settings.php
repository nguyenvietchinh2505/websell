	...
	'facebook_pixel'   => array(
		...
		'fields'   => array(
			...
			array(
				...
				'type'   => 'checklist',
				'label'  => '',
				'hint'   => __( 'Note: FunnelKit will send total order value and store currency based on order. <a target="_blank" href="https://developers.facebook.com/docs/facebook-pixel/pixel-with-ads/conversion-tracking#add-value">Click here to know more.</a>', 'woofunnels' ),
				'values' => array(
					array(
			...
			array(
				...
				'label'  => '',
				'hint'   => __( 'Note: FunnelKit will send customer\'s email, name, phone, address fields whichever available in the order. <a target="_blank" href="https://developers.facebook.com/docs/facebook-pixel/pixel-with-ads/conversion-tracking#advanced_match">Click here to know more.', 'woofunnels' ),
				'values' => array(
					array(
	...
	'google_ads'       => array(
		...
		'fields'   => array(
			array(
				...
				'hint'  => __( 'Log into your Google Ads account to find your Conversion ID. <a target="_blank" href="https://funnelkit.com/docs/funnel-builder/global-settings/google-ads/#step-1-go-to-your-google-ads-account">Click here for more information.</a>', 'woofunnels' ),
			),
			...
			array(
				...
				'hint'  => __( 'Log into your Google Ads account to find your conversion label. <a target="_blank" href="https://funnelkit.com/docs/funnel-builder/global-settings/google-ads/#step-4-set-up-the-conversion-for-your-google-ads-account">Click here for more information.</a>', 'woofunnels' ),
	...
	'pinterest'        => array(
		...
		'fields'  => array(
			array(
				...
				'hint'  => __( 'Log into your Pinterest Ads Manager Account and find Pixel ID. <a target="_blank" href="https://funnelkit.com/docs/funnel-builder/global-settings/pinterest/">Click here for more information.</a>.', 'woofunnels' )
			),
	...
	'tiktok'           => array(
		...
		'fields'   => array(
			array(
				...
				'hint'  => __( 'Log into your Tiktok Business Account and find TikTok ID. <a target="_blank" href="https://funnelkit.com/docs/funnel-builder/global-settings/tiktok/">Click here for more information.</a>.', 'woofunnels' )
	...
	'snapchat'         => array(
		...
		'fields'   => array(
			array(
				...
				'type'  => 'input',
				'label' => __( 'Pixel ID', 'woofunnels' ),
				'hint'  => __( 'Log into your Snapchat Business Account and find Pixel ID. <a target="_blank" href="https://funnelkit.com/docs/funnel-builder/global-settings/snapchat/">Click here for more information.</a>.', 'woofunnels' )
	...
	'utm_parameter'    => array(
		...
		'fields'   => array(
			...
			array(
				...
				'styleClasses' => [ 'wfacp_checkbox_wrap', 'wfacp_setting_track_and_events_end' ],
				'hint'         => __( 'Enable this option to track conversions along with your tracking events. <a target="_blank" href="https://funnelkit.com/docs/funnel-builder/global-settings/conversion-tracking">Click here for more information.</a>.', 'woofunnels' )
			),
		),
		'priority' => 40,
	),
