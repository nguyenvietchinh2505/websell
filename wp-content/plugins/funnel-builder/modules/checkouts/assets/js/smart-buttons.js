    ...
    class WFACP_Smart_Button_JS {
        ...
        getAvailableButtons() {
            return {
                ...
                "#wfacp_smart_button_wc_payment_gpay_apay #wcpay-payment-request-wrapper #wcpay-payment-request-button": "#wfacp_smart_button_wc_payment_gpay_apay",
            ...
            return wfacp_frontend.hooks.applyFilters('wfacp_smart_button_selectors', button_selectors, this);
        }
