...
(function ($) {
    ...
    (function () {
        if (wfacp_analytics_data.hasOwnProperty('pint') && wfacp_analytics_data.pint.hasOwnProperty('id')) {
            wfacp_analytics_data.wfacp_frontend.tracks.pint = new Pinterest(wfacp_analytics_data.pint);
        }
    })();
    (function () {
        if (wfacp_analytics_data.hasOwnProperty('tiktok') && wfacp_analytics_data.tiktok.hasOwnProperty('id')) {
            TikTok.enqueue_js();
            wfacp_analytics_data.wfacp_frontend.tracks.tiktok = new TikTok(wfacp_analytics_data.tiktok);
        }
    })();
    (function () {
