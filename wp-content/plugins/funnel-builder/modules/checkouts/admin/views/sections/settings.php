        ...
        <div class="wfacp_wrap_inner wfacp_wrap_inner_offers">
            <div class="wfacp-product-tabs-view-vertical wfacp-product-widget-tabs">
                <div class="wfacp-product-tabs-wrapper wfacp-tab-center ">
                    <div id="wfacp-global-checkout" data-tab="1" role="tab" class="wfacp-tab-title wfacp-tab-desktop-title wfacp_tracking_analytics wfacp-hide-action"><?php esc_html_e( 'Tracking Analytics', 'woofunnels-aero-checkout' ) ?></div>
					<div id="wfacp-tracking-analytics" data-tab="2" role="tab" class="wfacp-tab-title wfacp-tab-desktop-title wfacp_tracking_analytics"><?php esc_html_e( 'External Scripts', 'woofunnels-aero-checkout' ) ?></div>
					<div id="wfacp-permalink" data-tab="3" role="tab" class="wfacp-tab-title wfacp-tab-desktop-title wfacp_tracking_analytics"><?php esc_html_e( 'Custom CSS', 'woofunnels-aero-checkout' ) ?></div>
                                ...
                                <div class="wfacp_global_container">
                                    <form @change="changed()" v-on:submit.prevent="save()">
                                        ...
                                        <div class="bwf_ajax_save_buttons bwf_form_submit wfacp-hide-div">
                                            <button type="submit" class="wfacp_save_btn_style"><?php esc_html_e( 'Save Changes', 'woofunnels-aero-checkout' ); ?></button>
