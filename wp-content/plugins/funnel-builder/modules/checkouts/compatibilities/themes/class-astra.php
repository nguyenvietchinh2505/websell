...
class WFACP_Compatibility_With_Astra {
	...
	public function internal_css() {
		...
		$cssHtml .= "body #wfob_wrap .wfob_bgBox_tablecell.wfob_check_container .wfob_content_sec label{opacity: 1;max-width: 100%;position: relative;margin: 0;padding: 0;white-space: inherit;line-height: 1.5;}";
