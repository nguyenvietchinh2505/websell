...
class WFACP_Compatibility_Klarna_checkout {
	...
	public function klarna_checkout_installed() {
        ...
        <div class="error" style="margin-top:74px">
            <p>
				<?php
				_e( '<strong> Attention: </strong>You are using Klarna Checkout which completely takes over the checkout. To have best experience with FunnelKit Checkout please activate <a href="https://wordpress.org/plugins/klarna-payments-for-woocommerce/" target="_blank">Klarna Payments</a>.', 'woofunnels-aero-checkout' );
				?>
            </p>
        </div>
		<?php
