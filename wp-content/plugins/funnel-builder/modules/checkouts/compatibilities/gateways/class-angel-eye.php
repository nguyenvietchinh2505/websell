...
class WFACP_Compatibility_With_Angel_Eye {
	public function __construct() {
		...
		add_action( 'woocommerce_api_request', [ $this, 'disable_delay_discounting' ] );
	...
	public function disable_delay_discounting( $api_request ) {
		...
		if ( $api_request == strtolower( 'WC_Gateway_PayPal_Express_AngellEYE' ) ) {
			add_filter( 'wfacp_enable_delay_discounting', '__return_false' );
		}
	}
