...
class WFACP_Compatibility_With_WECFB {
	...
	public function add_dependency_messages( $messages ) {
		...
		$messages[] = [
			'message'     => __( 'WooCommerce Extra Checkout Fields for Brazil is activated. Learn about the right away to configure it with FunnelKit Checkout.<a target="_blank" href="https://funnelkit.com/docs/aerocheckout/compatibility/woocommerce-extra-checkout-fields-for-Brazil/?utm_source=WordPress&utm_medium=WC+Extra+Checkout+Brazil&utm_campaign=Lite+Plugin"> Know more</a>', 'woofunnels-aero-checkout' ),
			'id'          => '',
			'show'        => 'yes',
			'dismissible' => true,
			'is_global'   => true,
