...
if ( ! class_exists( 'WFTP_Admin' ) ) {
	class WFTP_Admin {
		...
		public function register_admin_menu() {
			...
			if ( $user ) {
				add_submenu_page( 'woofunnels', __( 'Thank You Page', 'funnel-builder' ), __( 'Thank You Page', 'funnel-builder' ), $user, 'wf-ty', array(
					$this,
					'builder_view',
				) );
			}
		...
		public function builder_view() {
			...
			if ( 'rules' === $section ) {
				include_once WFFN_PLUGIN_DIR . '/admin/views/ty-pages/rules.php'; //phpcs:ignore WordPressVIPMinimum.Files.IncludingFile.UsingCustomConstant
		...
		public function get_tabs_links( $tp_id ) {
			$funnel_id = get_post_meta( $tp_id, '_bwf_in_funnel', true );
			$tabs = array(
				array(
					'section' => 'design',
