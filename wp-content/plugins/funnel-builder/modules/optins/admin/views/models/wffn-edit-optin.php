...
/**
 * Edit Optin page model
 */
?>
<!-----  EDIT MODAL  ------->
<div id="wf_optin_edit_modal" class="iziModal" data-izimodal-group="alerts">
	<div id="part-update-optin">

		<div v-if="`1`==current_state" class="wffn-update-optin-form">
			<div class="wf_funnel_popup_header">
				<div class="wf_funnel_pop_title"><?php esc_html_e( 'Edit Optin Page', 'funnel-builder' ); ?></div>
			...
			<div class="wf_funnel_pop_body">
				<form class="wffn_forms_update_optin wffn_swl_btn">
					<div class="bwfabt_row">
						<div class="bwfabt_vue_forms">
							<vue-form-generator ref="update_optin_ref" :schema="schema" :model="model" :options="formOptions"></vue-form-generator>
						</div>
					</div>
					...
					<div class="wffn-modal-action">
						...
						<input type="button" v-on:click="updateOptin()" class="wf_funnel_btn wf_funnel_btn_primary" value="Update"/>
					</div>
				</form>
			</div>
		</div>

		<div v-if="`2`===current_state" class="wffn-updating-optin">
			<div class="wf_funnel_pop_body">
				<div class="bwfabt_row">
				...
				<div class="wf_funnel_clear_20"></div>
				<div class="wf_funnel_center_align">
					<div class="wf_funnel_h3"><?php esc_html_e( 'Updating the Optin Page', 'funnel-builder' ); ?></div>
		...
		<div v-if="`3`===current_state" class="wffn-funnel-updated">
			<div class="wf_funnel_pop_body">
				...
				<div class="wf_funnel_clear_20"></div>
				<div class="wf_funnel_center_align">
					<div class="wf_funnel_h3"><?php esc_html_e( 'Great! The Optin page has been successfully updated', 'funnel-builder' ); ?></div>
				</div>
				<div class="wf_funnel_clear_30"></div>
			</div>
		</div>
