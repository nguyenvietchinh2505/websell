...
$css[".bwfac_forms_outer.wfop-custom-form .bwfac_form_sec label"] = $label_color;
// phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UndefinedVariable
...
$css[".bwfac_forms_outer.wfop-custom-form .bwfac_form_sec :-moz-placeholder"]           = $text_color;
// phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UndefinedVariable
$css['.bwfac_forms_outer.wfop-custom-form .bwfac_form_sec input[type="text"], .bwfac_forms_outer.wfop-custom-form .bwfac_form_sec input[type="email"], .bwfac_forms_outer.wfop-custom-form .bwfac_form_sec input[type="tel"], .bwfac_forms_outer.wfop-custom-form .bwfac_form_sec select, .bwfac_forms_outer.wfop-custom-form .bwfac_form_sec textarea'] = 'border:' . $customizations['input_border_size'] . 'px ' . $customizations['input_border_type'] . ' ' . $customizations['input_border_color'] . ';' . $text_color . $bg_color;
