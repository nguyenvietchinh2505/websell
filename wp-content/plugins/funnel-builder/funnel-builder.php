...
if ( ! class_exists( 'WFFN_Core' ) ) {
	...
	class WFFN_Core {
		...
		public function __construct() {
			 ...
			 */
			add_action( 'activated_plugin', array( $this, 'fk_pro_delete_wizard_data' ), 10, 1 );
		...
		public function define_plugin_properties() {
			...
			define( 'WFFN_VERSION', '2.12.0' );
			define( 'WFFN_BWF_VERSION', '1.10.11.5' );
		...
		public function plugin_activation_hook() {
			...
			/** Save the plugin first version when the plugin was activated */
		...
		function fk_pro_delete_wizard_data( $plugin ) {
			if ( ! headers_sent() && 'funnel-builder-pro/funnel-builder-pro.php' === $plugin || 'funnel-builder-basic/funnel-builder-basic.php' === $plugin ) {
